...
<div class="main-header">
    ...
    <p>Tác giả: Lù Văn Khải - Trường PTDTBT Tiểu học Mậu Long, xã Mậu Duệ - ĐT: 0969047407</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lù Văn Khải - Trường PTDTBT Tiểu học Mậu Long, xã Mậu Duệ - ĐT: 0969047407</div>", unsafe_allow_html=True)
